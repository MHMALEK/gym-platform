...
const translation = {
  ...
  assignPlanToClients: {
    ...
    titleNutrition: "Assign nutrition template to clients",
    ...
    assign: "Assign",
    noClients: "Select at least one client.",
    success: "Assigned to {{count}} client(s).",
    failed: "Could not assign. Try again or check the client’s access.",
  },
  actions: {
    save: "Save",
    cancel: "Cancel",
  ...
  dashboard: {
    ...
    financeOverdueList: "Overdue invoices",
    financeDueSoonList: "Due in the next 7 days",
  ...
  clients: {
    ...
    membershipUnknown: "Membership",
    membershipRenamePlanHint: "Tip: rename the plan under Membership products if it matches a client name.",
    ...
    edit: {
      ...
      tabInvoices: "Invoices",
      tabMembership: "Membership",
      editModeTitle: "Editing this client",
      editModeDescription:
        "Same tabs as view: Profile (Save in the header), Workout & diet to assign saved programs or open the full editor, Invoices and Membership for billing.",
      profileEditHint:
        "Profile fields use Save in the header. Other tabs have their own save actions.",
    ...
    wizard: {
      ...
      stepWorkoutDietHint:
        "Your saved workouts and nutrition templates are listed below. Use the radio in each row to assign one plan per section when you save the client.",
      assignPlansHint:
        "Selected plans are copied into this client’s program (structured workout, overview, venue, and meals) the same way as Load / Apply in the full editor.",
      assignColumn: "Assign",
      assignWorkoutAria: "Assign workout {{name}} to this client",
      assignNutritionAria: "Assign nutrition template {{name}} to this client",
    ...
    plans: {
      ...
      editPickersTitle: "Workout & diet program",
      editPickersHint:
        "Assign a saved workout and/or nutrition template below — it applies to this client right away. To build or edit exercises, meals, rich text, and notes, open the full program editor.",
      assignWorkoutToClient: "Assign to client",
      assignNutritionToClient: "Assign meals",
      editWorkoutAssigned: "Workout program assigned to this client.",
      editNutritionAssigned: "Nutrition meals assigned to this client.",
      editPickersWorkoutSub: "Select a workout you already built under My workouts.",
      editPickersNutritionSub: "Select a nutrition template you created under My nutrition templates.",
      applySelection: "Apply to client",
      applySelectionSuccess: "Program updated for this client.",
      applySelectionError: "Could not apply. Try again.",
      editPickersNothingSelected: "Select a workout or nutrition template (or both), then apply.",
      editPickersFullEditorLead: "Need the drag-and-drop builder, rich text, or detailed notes?",
      openFullEditorLink: "Open full program editor",
      assignedProgramsHeading: "Assigned programs",
      assignedWorkoutLabel: "Workout program",
      assignedNutritionLabel: "Nutrition template",
      noneAssigned: "No saved workout or nutrition template is linked yet. Assign one below, or open the full editor.",
      noneDash: "—",
      assignedUnknownPlan: "(Unknown plan)",
      assignedUnknownTemplate: "(Unknown template)",
      removeWorkoutAssignment: "Remove workout",
      removeNutritionAssignment: "Remove nutrition",
      removeWorkoutAssignmentTitle: "Remove workout program?",
      removeNutritionAssignmentTitle: "Remove nutrition template?",
      removeWorkoutAssignmentBody:
        "This clears the linked workout and all structured exercises and overview text for this client. Free-text workout notes are kept.",
      removeNutritionAssignmentBody:
        "This clears the linked nutrition template and all structured meals for this client. Free-text diet notes are kept.",
      confirmRemove: "Remove",
      clearedWorkoutAssignment: "Workout assignment removed.",
      clearedNutritionAssignment: "Nutrition assignment removed.",
      changeAssignmentEditPage: "Change assignment (edit client)",
      changeAssignmentEditHint: "Use the tables below to assign a different saved program, or open the full editor for detailed edits.",
      rowAssignedBadge: "Assigned",
    },
  },
  planTemplates: {
    list: {
  ...
  memberships: {
    ...
    panel: {
      ...
      ends: "Ends",
      status: "Status",
      noSubscriptionsYet: "No memberships yet — assign a plan below when you’re ready.",
      extend: "Extend",
      extend30: "+30d",
      createInvoice: "Invoice from membership",
      invoiceCreated: "Invoice created.",
      editDates: "Edit dates",
      summarySectionTitle: "Active memberships",
      emptyStateTitle: "No memberships yet",
      emptyStateHint: "Assigned plans appear here with dates and status. Use the form below to add one.",
      assignTitle: "Assign membership",
      assignSubheader: "Pick a plan and when it starts. End date can follow the plan’s default length or be set manually.",
      planField: "Plan",
      planPh: "Select membership plan",
      start: "Start date & time",
      endMode: "End date",
      endModeExtra:
        "When on, the end date is calculated from the plan’s default length. Turn off to pick a custom end, or use the button below to preview a fixed duration.",
      ...
      loadTemplatesError: "Could not load membership plans. Refresh the page or check your connection.",
  ...
  invoices: {
    ...
    form: {
      notesClient: "Notes (client / PDF)",
      internalNotes: "Internal notes (coach only)",
      paidAt: "Paid at",
      payOnline: "Pay online",
      paymentsPlaceholder: "Card and wallet payments will connect here later. Record payment manually or use PDF for now.",
  ...
  workouts: {
    ...
    colHold: "Hold",
    colHoldHint: "Hold time per set (seconds). Useful for planks, isometric holds, etc.",
    colRest: "Rest",
    colRestHint: "Rest between sets (seconds).",
    collapseBlock: "Collapse",
    expandBlock: "Expand",
    customizeSet: "Customize this set",
    customizeHead: "Edit exercise defaults",
    headTargetsHint: "Defaults · click to edit",
    autoSaveIdle: "Auto-saves as you edit",
    autoSaving: "Saving…",
    autoSaved: "Saved",
    ungroupBlock: "Ungroup",
    ungroupBlockHint: "Detach all exercises from this block. Sets are kept.",
    pickerGroupTitle: "Build a block",
    pickerGroupEmpty: "Pick at least two exercises below to build a block.",
    pickerGroupCreate: "Create block",
    colNotes: "Notes",
