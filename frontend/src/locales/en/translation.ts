...
const translation = {
  ...
  clients: {
    ...
    plans: {
      ...
      templatesSectionTitle: "Nutrition templates",
      templateApplyHint:
        "Filter the list, apply meals to this client in one click, or open a template to edit it. Nothing is hidden in a dropdown.",
