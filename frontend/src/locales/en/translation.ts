...
const translation = {
  ...
  exercises: {
    ...
    mediaGallery: {
      ...
      hint: "Upload images or short demo videos. Set one thumbnail and optionally one primary demo video; the rest stay in the gallery. External URLs below still work for catalog-style links.",
      upload: "Upload files",
      ...
      remove: "Remove",
      afterCreateHint:
        "After you save this exercise, open it again to upload a gallery of photos and videos (or keep using the demo and thumbnail URL fields).",
    },
  },
  trainingPlans: {
    list: {
